...
public final class httpNew

{
	// ---( internal utility methods )---

	final static httpNew _instance = new httpNew();

	static httpNew _newInstance() { return new httpNew(); }

	static httpNew _cast(Object o) { return (httpNew)o; }
	...
	public static final void httpClientWithProxy (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(httpClientWithProxy)>> ---
		// @sigtype java 3.5
		...
		try {
			...
			//SINGLETON_SHARED_CLIENT = doGetHttpClient(cursor);
			...
			//CloseableHttpResponse response = SINGLETON_SHARED_CLIENT.execute(HOST, request);
			//debugLog("[BRIVA] [client] : "+client+" [host] : "+host+ " [request] : "+request);
			CloseableHttpResponse response = client.execute(host, request);
			//debugLog("[BRIVA] done executing " + response);
			//HOST = null;
	...
	public static final void httpClientWithProxyBypassSSL (IData pipeline)
        throws ServiceException
	{
